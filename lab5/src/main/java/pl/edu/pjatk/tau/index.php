...
<div id="loginForm">
    ...
    <form action="login.php" method="POST" id="formularzyk" >
        <h1>LOGOWANIE</h1>
        <input  type="text" id ="loginTextBox" name="login" placeholder="Login" required ></br>
        <input  type="password" id ="passTextBox" name="password" placeholder="Hasło" required><br/>
...
<div id="registerForm">
    ...
    <div id = "page">
        ...
        <div id = "content">
            ...
            <button id="buttonJS">Kliknij mnie, żeby sprawdzić czy JS działa</button>
